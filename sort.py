    ...
    for char in string_name:
        ...
        if char.isalnum():
            if char in translit_dict:
                ...
                name_object += translit_dict[char.lower()].capitalize(
                ) if char.isupper() else translit_dict[char.lower()]
            else:
                name_object += char
        else:
            name_object += '_'
